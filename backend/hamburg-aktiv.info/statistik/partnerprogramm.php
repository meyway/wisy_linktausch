<?php
     ...
     * 
     * Diese Datei wertet die Zugriffe auf HH-Aktiv aus, die auf "#partner" enden,
    ...
    define("URL_THIS", "http://hamburg-aktiv.info/files/hh/hamburgaktiv/linktausch/statistik/partnerprogramm.php");
    
    define("MAIL_FROM", "nobody@hamburg-aktiv.info");
    define("MAIL_TO", ""); // E-Mailadresse ergänzen!
    define("MAIL_BCC", "");
    define("MAIL_SUBJECT", "HH-Aktiv // Monatliche Auswertung: Partner-Banner");    
    define("MAIL_SIGNATURE", "\n\n\n-- \nDiese E-Mail wurde automatisch erzeugt von\n/files/hh/hamburgaktiv/linktausch/statistik/partnerprogramm.php\nFragen: ".MAIL_BCC);    
